...
class CreateForm1(forms.Form):
    ...
    collection = fields.ChoiceField(choices=models.ProductCollection.collection_manager.for_forms())
        ...
        if not debug_mode:
            if form_is_valid and self.current_step == 1:
                ...
                form_is_valid.cleaned_data['collection'] = models.ProductCollection.\
                            objects.get(collection_name=form_is_valid.cleaned_data['collection'])
